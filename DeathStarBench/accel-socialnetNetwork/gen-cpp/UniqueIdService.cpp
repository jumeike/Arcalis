...
#ifdef ENABLE_GEM5
UniqueIdService_ComposeUniqueId_args::UniqueIdService_ComposeUniqueId_args(const UniqueIdService_ComposeUniqueId_args& other)
    : req_id(other.req_id), post_type(other.post_type), carrier(other.carrier) {}

UniqueIdService_ComposeUniqueId_args& UniqueIdService_ComposeUniqueId_args::operator=(const UniqueIdService_ComposeUniqueId_args& other) {
    if (this != &other) {
        req_id = other.req_id;
...
#ifdef ENABLE_GEM5
UniqueIdService_ComposeUniqueId_result::UniqueIdService_ComposeUniqueId_result(const UniqueIdService_ComposeUniqueId_result& other)
   : success(other.success), se(other.se), __isset(other.__isset) {}

UniqueIdService_ComposeUniqueId_result& UniqueIdService_ComposeUniqueId_result::operator=(const UniqueIdService_ComposeUniqueId_result& other) {
   if (this != &other) {
...
#ifdef ENABLE_GEM5
bool UniqueIdServiceProcessor::process(
    std::shared_ptr<apache::thrift::protocol::TProtocol> in,
    std::shared_ptr<apache::thrift::protocol::TProtocol> out,
    void* connectionContext) {
    auto& bl = std::dynamic_pointer_cast<UniqueIdHandler>(iface_)->business_logic_;
...
void UniqueIdServiceProcessor::process_ComposeUniqueId(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext) {
    ...
    auto& bl = std::dynamic_pointer_cast<UniqueIdHandler>(iface_)->business_logic_;
    bl->ctx_ = ctx;  // Store context

    UniqueIdService_ComposeUniqueId_result result;
    try {
        result.success = iface_->ComposeUniqueId(bl->args_.req_id, bl->args_.post_type, bl->args_.carrier);
    ...
    bl->result_ = result;  // Store result for callSWwrite()
}
