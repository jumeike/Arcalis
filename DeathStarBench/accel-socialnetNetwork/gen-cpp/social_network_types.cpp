...
bool UserMention::operator==(const UserMention & rhs) const
{
  if (!(user_id == rhs.user_id))
    return false;
  if (!(username == rhs.username))
...
bool Creator::operator==(const Creator & rhs) const
{
  if (!(user_id == rhs.user_id))
    return false;
  if (!(username == rhs.username))
...
bool TextServiceReturn::operator==(const TextServiceReturn & rhs) const
{
  if (!(text == rhs.text))
    return false;
