...
private:
   ...
   uint8_t* recv_buf_ = new uint8_t[1024*1024];    // Receive Buffer
   uint8_t* resp_buf_ = new uint8_t[1024*1024];    // Response Buffer 
  //uint8_t recv_buf_[1024*1024];    
  //uint8_t resp_buf_[1024*1024]; 
